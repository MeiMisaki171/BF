...
const Seo = ( ) => {
  ...
  return (
    <div className='seo'>
        <h2>Vì sao bạn nên Order trên GrabFood</h2>
        <ul className='seo-list'>
            <li>
                <span className='bold'>Nhanh nhất</span>
                <span> - GrabFood cung cấp dịch vụ giao đồ ăn nhanh nhất thị trường. </span>
            </li>
            <li>
                <span className='bold'>Dễ dàng nhất</span>
                <span> - Giờ đây, bạn chỉ cần thực hiện vài cú nhấp chuột hoặc chạm nhẹ là đã có thể đặt đồ ăn. Hãy đặt đồ ăn trực tuyến hoặc tải xuống siêu ứng dụng Grab của chúng tôi để có thể trải nghiệm nhanh hơn và thú vị hơn.</span>
            </li>
            <li>
                <span className='bold'>Đáp ứng mọi nhu cầu</span>
        ...
        <div className='more'>
            ...
            <p>Sau đây là cách đơn giản nhất để đặt đồ ăn qua GrabFood khi bạn ở Việt Nam:</p>
              <ol>
                  ...
                  <li>
                      <span className='bold'>Kiểm tra & Thanh toán</span>
                  ...
                  <li>
                      <span className='bold'>Giao hàng</span>
              ...
              <div className='ant-driver ant-divider-horizoltal'></div>
              <h3>Tôi có thể thanh toán trực tuyến trên GrabFood cho đơn hàng của mình không?</h3>
              <p>GrabFood chấp nhận nhiều hình thức thanh toán cho các đơn đặt đồ ăn trực tuyến, bao gồm cả thanh toán trực tuyến tại Việt Nam bằng thẻ tín dụng, thẻ ghi nợ, PayPal hoặc trả tiền lúc nhận hàng. Hãy nhớ sử dụng <a className='link-text' href='https://www.grab.com/vn/pay/'>Moca</a> để tích điểm thưởng mà bạn có thể sử dụng để được giảm giá cho đơn hàng tiếp theo và cho các dịch vụ khác của Grab nhé.

</p>
              <div className='ant-driver ant-divider-horizoltal'></div>
              <h3>Tôi có thể đặt đồ ăn trên GrabFood cho người khác không?</h3>
              <p>Tất nhiên rồi, hãy chăm sóc những người thân yêu của mình bằng cách gửi những món ăn mà họ yêu thích đến tận nhà. Bạn chỉ cần cập nhật địa chỉ giao hàng và tên người nhận trước khi đặt đơn hàng của bạn.</p>
              <div className='ant-driver ant-divider-horizoltal'></div>
              <h3>GrabFood tính phí giao đồ ăn như thế nào?</h3>
              <p>Phí giao hàng của chúng tôi phụ thuộc vào nhiều yếu tố hoạt động như khoảng cách từ vị trí của bạn đến nhà hàng. Bạn có thể kiểm tra phí giao hàng chính xác cần phải trả trước khi thanh toán tại mục thanh toán trên ứng dụng Grab. Ngoài ra còn có phần “Free Delivery” (Giao hàng miễn phí) liệt kê các nhà hàng gần chỗ bạn mà không tính phí giao hàng.

</p>
              <div className='ant-driver ant-divider-horizoltal'></div>
              <h3>Những nhà hàng nào được liệt kê trong GrabFood?</h3>
              <p>Chúng tôi có gì trên GrabFood? Chúng tôi tự hào có nhiều nhà hàng và món ăn nhất so với bất kỳ ứng dụng giao đồ ăn nào ở Việt Nam. Bạn có thể lựa chọn trong số hàng nghìn nhà hàng trên GrabFood Việt Nam. Bạn có thể đặt đồ ăn trực tuyến từ tất cả các điểm ăn uống yêu thích của Burger King, Jollibee, KFC, McDonalds, Long John Silver, Pastamania, Dominos Pizza, Pizza Hut, Subway!</p>
              <p>GrabFood cũng có mã khuyến mãi, ưu đãi và giảm giá có hạn dành riêng cho các nhà hàng trong danh mục. Bạn có thể được hưởng chiết khấu lớn và hàng loạt ưu đãi khác cho đơn đặt đồ ăn của mình. Giờ thì đặt đồ ăn thôi!</p>
              <div className='ant-driver ant-divider-horizoltal'></div>
              <h3>GrabFood có áp dụng giá trị đơn hàng tối thiểu không?</h3>
              <p>Có! Nhưng bạn có thể trả số tiền chênh lệch nếu giá trị đơn hàng của bạn nhỏ hơn số tiền đặt hàng tối thiểu.</p>
        </div>
          <button
              onClick={ readMore }
              type='button'
              className='ant-btn readmore ant-btn-block'
        >Read More</button>
    </div>
